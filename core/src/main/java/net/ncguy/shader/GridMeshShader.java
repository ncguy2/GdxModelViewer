...
public class GridMeshShader extends DefaultShader {

    static Config getDefaultConfig(Renderable renderable) {
        Config cfg = new Config();

        Shaders.ShaderRef ref = Shaders.GetShader("grid", Files.FileType.Internal);
    ...
    public GridMeshShader(Renderable renderable) {
